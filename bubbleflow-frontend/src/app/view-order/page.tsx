            ...
            <div onClick={() => {
              ...
              */
              ...
              const orderSubmission: OrderSubmission = {
                order_id: 0, // should be generated by backend
                customer: "John Doe", // Placeholder customer name
                order_date: new Date(), // Current date and time
                employee_id: 1, // Placeholder employee ID
                payment_method: "Credit Card", // Placeholder payment method
                order_items: parsedOrderItems.map((item: any) => ({
                  drink_id: item.id,
                  topping_ids: item.toppings.map((topping: any) => topping.id),
                })),
                };
